...
<style scoped>
/* Rating Container */
.talkie-rating-container-wrapper {
  display: flex;
  flex-direction: column;
  flex-wrap: wrap;
  align-items: center;
  max-width: calc(var(--t-space-36) * 10);
  width: 100%;
}
/* Rating Stars */
.talkie-rating-stars-wrapper {
  display: flex;
  width: 100%;
  justify-content: center;
  overflow: hidden;
  flex-direction: row-reverse;
  height: calc(var(--t-space-50) * 3);
  position: relative;
}
.talkie-rating-stars-wrapper > input {
  display: none;
}
.talkie-rating-stars-wrapper > label {
  cursor: pointer;
...
.talkie-rating-stars-wrapper > input:checked ~ label,
.talkie-rating-stars-wrapper > input:checked ~ label ~ label {
  background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' width='126.729' height='126.73'%3e%3cpath fill='%23f7d41e' d='M121.215 44.212l-34.899-3.3c-2.2-.2-4.101-1.6-5-3.7l-12.5-30.3c-2-5-9.101-5-11.101 0l-12.4 30.3c-.8 2.1-2.8 3.5-5 3.7l-34.9 3.3c-5.2.5-7.3 7-3.4 10.5l26.3 23.1c1.7 1.5 2.4 3.7 1.9 5.9l-7.9 32.399c-1.2 5.101 4.3 9.3 8.9 6.601l29.1-17.101c1.9-1.1 4.2-1.1 6.1 0l29.101 17.101c4.6 2.699 10.1-1.4 8.899-6.601l-7.8-32.399c-.5-2.2.2-4.4 1.9-5.9l26.3-23.1c3.8-3.5 1.6-10-3.6-10.5z'/%3e%3c/svg%3e");
}
.talkie-rating-stars-wrapper > input:not(:checked) ~ label:hover,
.talkie-rating-stars-wrapper > input:not(:checked) ~ label:hover ~ label {
  background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' width='126.729' height='126.73'%3e%3cpath fill='%23d8b11e' d='M121.215 44.212l-34.899-3.3c-2.2-.2-4.101-1.6-5-3.7l-12.5-30.3c-2-5-9.101-5-11.101 0l-12.4 30.3c-.8 2.1-2.8 3.5-5 3.7l-34.9 3.3c-5.2.5-7.3 7-3.4 10.5l26.3 23.1c1.7 1.5 2.4 3.7 1.9 5.9l-7.9 32.399c-1.2 5.101 4.3 9.3 8.9 6.601l29.1-17.101c1.9-1.1 4.2-1.1 6.1 0l29.101 17.101c4.6 2.699 10.1-1.4 8.899-6.601l-7.8-32.399c-.5-2.2.2-4.4 1.9-5.9l26.3-23.1c3.8-3.5 1.6-10-3.6-10.5z'/%3e%3c/svg%3e");
}
.talkie-rating-star-0 {
  filter: grayscale(100%);
}
/* Rating Emojis */
.talkie-rating-emoji-wrapper {
  width: 100%;
  text-align: center;
  height: calc(var(--t-space-50) * 2);
  overflow: hidden;
  position: absolute;
  top: 0;
  left: 0;
}
.talkie-rating-emoji-wrapper:before,
.talkie-rating-emoji-wrapper:after {
  content: "";
  height: var(--t-space-15);
  width: 100%;
  position: absolute;
  left: 0;
...
.talkie-rating-emoji > svg {
  margin: var(--t-space-15) 0;
  width: var(--t-space-70);
  height: var(--t-space-70);
  flex-shrink: 0;
}
#talkie-rating-star-1:checked
  ~ .talkie-rating-emoji-wrapper
  > .talkie-rating-emoji {
  transform: translateY(-100px);
}
#talkie-rating-star-2:checked
  ~ .talkie-rating-emoji-wrapper
  > .talkie-rating-emoji {
  transform: translateY(-200px);
}
#talkie-rating-star-3:checked
  ~ .talkie-rating-emoji-wrapper
  > .talkie-rating-emoji {
  transform: translateY(-300px);
}
#talkie-rating-star-4:checked
  ~ .talkie-rating-emoji-wrapper
  > .talkie-rating-emoji {
  transform: translateY(-400px);
}
#talkie-rating-star-5:checked
  ~ .talkie-rating-emoji-wrapper
  > .talkie-rating-emoji {
